...
class ItemsController extends Controller
{
            ...
            if(Yii::$app->request->isAjax){
                ...
                if (isset($_FILES) && $this->module->settings['articleThumb']) {
                    ...
                    if ($model->image && $model->validate(['image'])) {
                        $model->image = Image::upload($model->image, 'tfbarticle');
                    } else {
                        $model->image = '';
                    }
                }
                ...
                if ($model->save()) {
                    $this->flash('success', Yii::t('easyii/tfbarticle', 'Article created'));
    ...
    public function actionEdit($id)
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            if(Yii::$app->request->isAjax){
                ...
                if ($model->save()) {
                    $this->flash('success', Yii::t('easyii/tfbarticle', 'Article updated'));
                    return $this->redirect(['/admin/'.$this->module->id.'/items/edit', 'id' => $model->primaryKey]);
                } else {
    ...
    public function actionDelete($id)
    {
        ...
        return $this->formatResponse(Yii::t('easyii/tfbarticle', 'Article deleted'));
    }
